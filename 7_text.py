...
##############################################################################
#1. 사용자 게임 초기호 (배경화면, 게임 이미지, 좌표, 속도, 폰트 등)
#배경 이미지 불러오기 
background = pygame.image.load("C:\\Users\\82109\\OneDrive\\바탕 화면\\python workspace\\pygame_basic\\background.png")

#스프라이트(캐릭터) 불러오기
character =pygame.image.load("C:\\Users\\82109\\OneDrive\\바탕 화면\\python workspace\\pygame_basic\\character.png")
...
#적 캐릭터
enemy =pygame.image.load("C:\\Users\\82109\\OneDrive\\바탕 화면\\python workspace\\pygame_basic\\enemy.png")
